...
namespace NotNot.GodotNet.SourceGen.Helpers;


public static class zz_Extensions_ClassDeclarationSyntax
{
   public static string _GetNamespaceName(this ClassDeclarationSyntax classDeclaration)
   {
      ...
      while (true)
      {
         ...
         {
            namespaceNames.Add(namespaceDeclaration.Name.ToString());
            parent = parent.Parent;
         }
         else if (parent is FileScopedNamespaceDeclarationSyntax fileScopedNamespaceDeclaration)
         {
            namespaceNames.Add(fileScopedNamespaceDeclaration.Name.ToString());
            parent = parent.Parent;
         }
         else
         {
