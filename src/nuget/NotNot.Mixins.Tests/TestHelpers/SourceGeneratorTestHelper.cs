...
{
	/// <summary>
	/// Filters diagnostics to only include errors and warnings (excludes Info-level).
	/// Use this for assertions that check for "no errors".
	/// </summary>
	public static ImmutableArray<Diagnostic> ErrorsAndWarnings(this ImmutableArray<Diagnostic> diagnostics)
	{
