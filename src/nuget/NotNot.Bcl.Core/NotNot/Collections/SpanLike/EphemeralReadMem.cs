...
public readonly struct EphemeralReadMem<T>
{
	...
	public static implicit operator EphemeralReadMem<T>(EphemeralMem<T> mem) => new(mem._backingStorageType, mem._backingStorage, mem._segmentOffset, mem._segmentCount);
