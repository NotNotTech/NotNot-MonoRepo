...
namespace NotNot.Collections.obsolete
{
	/// <summary>
	...
	[Obsolete("Use FreeSlotStore instead")]
	public class FreeSlotStore_Old<T>
	{
		...
		public FreeSlotStore_Old(int initialCapacity = 10)
		{
