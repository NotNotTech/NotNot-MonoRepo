...
public sealed class InlineCompositionGenerator : IIncrementalGenerator {
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context) {
        ...
        RegisterProvider(context, "NotNot.MixinsAttributes.InlineAttribute`1");
        RegisterProvider(context, "NotNot.MixinsAttributes.InlineAttribute`2");
        RegisterProvider(context, "NotNot.MixinsAttributes.InlineAttribute`3");
        RegisterProvider(context, "NotNot.MixinsAttributes.InlineAttribute`4");
        RegisterProvider(context, "NotNot.MixinsAttributes.InlineAttribute`5");
        RegisterProvider(context, "NotNot.MixinsAttributes.InlineAttribute`6");
        RegisterProvider(context, "NotNot.MixinsAttributes.InlineAttribute`7");
        RegisterProvider(context, "NotNot.MixinsAttributes.InlineAttribute`8");
        RegisterProvider(context, "NotNot.MixinsAttributes.InlineAttribute`9");
        RegisterProvider(context, "NotNot.MixinsAttributes.InlineAttribute`10");
        RegisterProvider(context, "NotNot.MixinsAttributes.InlineAttribute`11");
        RegisterProvider(context, "NotNot.MixinsAttributes.InlineAttribute`12");
